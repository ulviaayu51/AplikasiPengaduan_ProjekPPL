...
<html>
  ...
  <body style="background: #346698">
    ...
    <div style="background:white;margin:20px;padding:10px">
      ...
      <a class="btn btn-outline-success my-2 my-sm-0" target="_blank" href="<?php echo base_url()?>index.php/Welcome/cetakPengaduan" >Cetak</a>
    </div>

     <div class="modal fade" id="modal_bp" tabindex="-1" role="dialog" aria-hidden="true"></div>
